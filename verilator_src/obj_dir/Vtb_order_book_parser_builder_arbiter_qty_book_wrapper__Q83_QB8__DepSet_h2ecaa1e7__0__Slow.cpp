...
VL_ATTR_COLD void Vtb_order_book_parser_builder_arbiter_qty_book_wrapper__Q83_QB8___ctor_var_reset(Vtb_order_book_parser_builder_arbiter_qty_book_wrapper__Q83_QB8* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_order_book_parser_builder_arbiter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_order_book_parser_builder_arbiter_qty_book_wrapper__Q83_QB8___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->bid_qty_builder_inst__DOT____VdfgExtracted_hd5c3f456__1 = VL_RAND_RESET_I(1);
    vlSelf->bid_qty_builder_inst__DOT____VdfgExtracted_hfec9ef15__1 = VL_RAND_RESET_I(1);
