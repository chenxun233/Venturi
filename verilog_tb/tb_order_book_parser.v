...
module tb_order_book_parser;
    ...
    task automatic load_snapshot_bytes;
        ...
        begin
            ...
            set16('h0000, 128'h01 00 5e 00 00 01 00 11 22 33 44 55 08 00 45 00);
            set16('h0010, 128'h01 1a 00 01 00 00 40 11 cc f3 c0 a8 01 32 e9 01);
            set16('h0020, 128'h02 03 15 b3 04 d2 01 06 31 1c 4e 41 53 44 51 54);
            set16('h0030, 128'h45 53 54 20 00 00 00 00 00 00 00 01 00 07 00 28);
            set16('h0040, 128'h46 00 0d 00 00 1b d6 53 cf f0 bf 00 00 00 00 00);
            set16('h0050, 128'h00 00 01 42 00 00 02 64 41 41 50 4c 20 20 20 20);
            set16('h0060, 128'h00 23 5d e8 54 53 53 4d 00 17 58 00 0d 00 00 1b);
            set16('h0070, 128'h2e c7 3b cc cf 00 00 00 00 00 00 00 01 00 00 00);
            set16('h0080, 128'h96 00 24 43 00 0d 00 01 1f 1a fd 1d 81 79 00 00);
            set16('h0090, 128'h00 00 00 00 00 01 00 00 00 df 00 00 00 00 00 02);
            set16('h00a0, 128'h8c 56 4e 00 2c 2a 40 00 1f 45 00 0d 00 02 0d 73);
            set16('h00b0, 128'h25 a3 d0 68 00 00 00 00 00 00 00 01 00 00 00 16);
            set16('h00c0, 128'h00 00 00 00 00 00 46 27 00 24 41 00 0d 00 00 0d);
            set16('h00d0, 128'h18 c3 4e 77 da 00 00 00 00 00 00 00 02 53 00 00);
            set16('h00e0, 128'h00 10 41 41 50 4c 20 20 20 20 00 2d c2 d8 00 23);
            set16('h00f0, 128'h55 00 0d 00 00 1e 96 69 a4 b6 a9 00 00 00 00 00);
            set16('h0100, 128'h00 00 02 00 00 00 00 00 00 00 03 00 00 00 64 00);
            set16('h1110, 128'h2c 36 5c 00 13 44 00 0d 00 00 0d 20 7f 24 3f 50);
            set8 ('h1120, 64 'h00 00 00 00 00 00 00 03);
        end
    endtask
