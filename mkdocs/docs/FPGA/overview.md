...
The setup is also given here:
![setup](../figures/FPGA/top%20level/setup.png)

The jtag wires were soldered to an adapter to the golden fingers in Exanic x10, which does not have a standard jtag interface. The soldering procedure can be found in this link:
[Connect gold fingers to JTAG](https://www.youtube.com/watch?v=wPZafeahZwY&t=52s).
...
- [timestamper](timestamper.md): generates the exported event timestamp (Actually there should be one stamp at the mac layer).
